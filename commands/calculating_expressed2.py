...
if ".gff" in sys.argv[1] and ".out" in sys.argv[2]:
    ...
    # We create an index (a dictionary) that takes as key the ID of the protein and as value the product
    index={}
    ...
    # We create a list of the proteins that are expressed at least once
    output=[]
    count_expr=0
    count_not_expr=0
    ...
    print("The files are not correct. As a reminder the command should look like $ python3 count.py <gff_file> <out_fileo>")
